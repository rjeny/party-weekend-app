...
export default async function seed() {
	...
	await db.insert(Events).values([
		...
		{ title: 'event 1', ...getEvent(wednesday, 9, 0, 120) },
		...
		{ title: 'event 4', ...getEvent(sunday, 12, 45, 360) },
		{ title: 'event 5', ...getEvent(sunday, 13, 0, 120) },
		{ title: 'event 6', ...getEvent(sunday, 13, 0, 360) },
